...
const SettingsPanel: React.FC = () => {
  ...
  const [requirePQ, setRequirePQ] = useState(true);
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card p-6">
        <h3 className="section-title flex items-center gap-2 mb-4">
          <HiOutlineCog6Tooth size={20} className="text-primary-400" />
          Update Preferences
        </h3>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-dark-800/50 rounded-xl">
            ...
            <select
              ...
              className="bg-dark-700 border border-dark-600 rounded-lg px-3 py-1.5 text-sm text-dark-200"
            >
          ...
          <div className="flex items-center justify-between p-4 bg-dark-800/50 rounded-xl">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={requirePQ}
                onChange={(e) => setRequirePQ(e.target.checked)}
                className="sr-only peer"
              />
