...
fn load_rustls_config() -> Result<ServerConfig> {
	...
	if cert_chain.is_empty() {
		anyhow::bail!("No certificates found in csr.pem");
	}
...
#[actix_web::main]   // ← use actix's runtime, not bare tokio
...
=======
	...
	.bind_rustls_0_23("127.0.0.1:8443", tls_config)?   // ← replaces bind_openssl
	.run()
	.await?;
